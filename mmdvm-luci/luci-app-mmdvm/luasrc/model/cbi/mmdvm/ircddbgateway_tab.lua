...
local input = uci:get("mmdvm", "ircddbgateway", "conf") or "/etc/ircddbgateway"
...
s = m:section(SimpleSection, nil,
	translatef("This form allows you to modify the .ini file of the ircDDBGateway (%s). ", input))
...
function f.write(self, section, data)
	...
	sys.call("/etc/init.d/ircddbgateway restart >/dev/null")
